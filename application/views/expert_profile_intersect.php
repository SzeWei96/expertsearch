    ...
    <div class="row">
        ...
        <div class="col-lg-9 col-md-9 col-sm-8">
            ...
            <div class="tab-content">                
                ...
                ?> -->
                <h2>
                       <center><b class="text-lg-center">Summary of Expert</b></center> 
                </h2>
                    ...
                    <div class="row" id="custom-padding">
                        <div class="col-xl-4 col-md-6 mb-3">
                            <div class="card text-white bg-info">
                                <div class="card-body text-center">
                                    <i class="material-icons card-icon-small mb-2">library_books</i> 
                                    <div class="container c-word d-flex align-items-center">
                                        <h5 class="c-single-content">Total Related Publication</h5>
                                    </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3"> 
                            <div class="card text-white bg-warning">
                                <div class="card-body text-center">
                                    <i class="fa fa-quote-right card-icon-small mb-2"></i> 
                                    <div class="container c-word d-flex align-items-center">
                                        <h5 class="c-single-content">Total Times Cited Of Related Publication</h5>
                                    </div>
                        ...
                        <div class="col-xl-4 col-md-6 mb-3"> 
                            <div class="card text-white bg-secondary">
                                <div class="card-body text-center">
                                    <i class="material-icons card-icon-sma
                                    ll mb-2">people_outline</i>
                                    <div class="container c-word d-flex align-items-center">
                                        <h5 class="c-single-content">Total Related Co-Authors (USM)</h5>
                                    </div>
                            ...
                            <div class="card-header">
                             ...
                             <div class="card-body">
                                ...
                                <div class="table-responsive">
                                   <table id="example" class="table table-striped table-bordered display" style="width:100%; border: 10px; overflow-y:auto;">
                                         <thead>
                                            <tr>
    ...
    am4core.ready(function() {
        ...
        if(<?php echo count($pub_categories['cat']); ?> != 0){
            ...
            if(document.getElementById("chartdiv2")){
                document.getElementById("chartdiv2").innerHTML = "No Words Available";
            }
        }
